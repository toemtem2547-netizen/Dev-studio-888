...
export const INITIAL_PROJECTS: ProjectItem[] = [
  {
    ...
    category: 'saas',
    catLabel: 'EdTech & Academic Library Portal',
    badge: 'Academic Portal',
    kpi: 'รวบรวม 947 ทรัพยากร 117 สาขา ค้นคว้าได้เร็วขึ้นกว่า 80%',
    ...
    problem: 'นักศึกษาและคณาจารย์กว่า 117 สาขาวิชา ประสบปัญหาในการค้นคว้าแหล่งข้อมูลทางวิชาการและงานวิจัย เนื่องจากแหล่งสืบค้นกระจัดกระจายและเข้าถึงได้ยาก',
    solution: 'ออกแบบและพัฒนาระบบ ARIT Web Subject Guide ที่จัดหมวดหมู่ทรัพยากรสารสนเทศตามสาขาวิชาแบบครบวงจร พร้อมระบบค้นหาอัจฉริยะ',
    results: 'เข้าถึงทรัพยากรได้สะดวกรวดเร็วในคลิกเดียว ลดเวลาสืบค้นงานวิจัยลง 80% และรองรับทราฟฟิกค้นคว้ากว่า 1,000+ รายการต่อวัน',
  },
  {
    id: 'proj-nexus-bi',
